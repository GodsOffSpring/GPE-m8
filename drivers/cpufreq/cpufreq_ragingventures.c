/*
 *  drivers/cpufreq/cpufreq_ragingventures.c
 *
...
define DEF_FREQUENCY_UP_THRESHOLD		(10)
#define DEF_TWO_PHASE_FREQUENCY			(1200000)
#define DEF_SAMPLING_DOWN_FACTOR		(1)
#define MAX_SAMPLING_DOWN_FACTOR		(100000)
#define MICRO_FREQUENCY_DOWN_DIFFERENTIAL	(3)
define MICRO_FREQUENCY_UP_THRESHOLD		(25)
...
static
#endif
struct cpufreq_governor cpufreq_gov_ragingventures = {
       .name                   = "RagingVentures",
...
static int __init cpufreq_gov_dbs_init(void)
{
	...
	return cpufreq_register_governor(&cpufreq_gov_ragingventures);
}
...
static void __exit cpufreq_gov_dbs_exit(void)
{
	...
	cpufreq_unregister_governor(&cpufreq_gov_ragingventures);
	for_each_possible_cpu(i) {
		struct cpu_dbs_info_s *this_dbs_info =
			&per_cpu(od_cpu_dbs_info, i);
#ifdef CONFIG_ARCH_MSM_CORTEXMP
...
MODULE_DESCRIPTION("'cpufreq_ragingventures' - A dynamic cpufreq governor for "
